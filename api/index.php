<?php
// Configurar encabezados CORS y tipo de contenido JSON
...
// Convertir cualquier error o advertencia de PHP en una respuesta JSON
set_error_handler(function($severity, $message, $file, $line) {
    ...
    echo json_encode([
        'success' => false,
        'message' => 'Error interno en el servidor PHP',
        'details' => $message,
        'file' => basename($file),
        'line' => $line
...
// Capturar excepciones no controladas (errores de base de datos, etc.)
